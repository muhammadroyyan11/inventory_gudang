    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mt-2 mb-2">
                        <a href="<?= base_url('stock/keluar') ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-square"></i> Input Barang Keluar</a>
                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-2">
                                        <label class="form-label">Metode Transaksi</label>
                                        <select name="metode_transaksi" id="metode_transaksi" class="form-control form-control-sm">
...
<script>
    $(document).ready(function() {
        ...
        $("body").on("click", "#filter", function() {
            ...
            $('#datatables').DataTable().destroy();
            table(tanggal, lokasi_id, pelanggan_id, metode_transaksi, status);
        })
    ...
    function table(tanggal, lokasi_id, pelanggan_id, metode_transaksi, status) {
        var table = $('#datatables').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "<?= base_url('keluar/ajax_table') ?>",
                type: "POST",
                data: {
                    tanggal: tanggal,
                    lokasi_id: lokasi_id,
