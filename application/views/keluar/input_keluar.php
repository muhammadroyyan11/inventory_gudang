...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#saveBtn', function(e) {
            ...
            var myurl = "<?= base_url('keluar/store') ?>";
    ...
    function getProdukLokasi(lokasi, id) {
        var url = "<?= base_url('keluar/getProdukLokasi') ?>?lokasi=" + lokasi + "&barang=" + id;
        $.ajax({
            type: "get",
            url: url,
            dataType: 'json',
    ...
    function addItemToCart(barang_id, lokasi_id, kode, barang, satuan = '', harga = 0, stock = 0, jumlah = 0, diskon = 0, min_stock = 0) {
        var id = barang_id;
        var item = {
            id: barang_id,
            lokasi_id: lokasi_id,
