        ...
        <div class="modal-content" style="background:#fafbfc !important">
            ...
            <div class="modal-body">
                <div class="text-center mb-3">
                    ...
                    <h4 id="modal-title" class="mt-2">Data Lokasi</h4>
                </div>
                <form id="form" class="form-horizontal">
                    <input type="hidden" name="id" id="id">
                    <div class="modal-body">
                        <div class="mb-2">
                            <label for="kode">Kode Lokasi <sup>(Optional)</sup></label>
...
<script>
    $(document).ready(function() {
        ...
        $("body").on('submit', '#form', function(e) {
            ...
            var id = $("#id").val();
            var url = "<?php echo base_url('lokasi/store') ?>";
            if (id != '') {
        ...
        $("body").on("click", ".edit", function() {
            ...
            $('#form')[0].reset();
            $.ajax({
                url: "<?php echo base_url('lokasi/get_by_id') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    $('#id').val(data.id);
        ...
        $("body").on("click", ".delete", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo base_url('lokasi/delete') ?>/" + id,
                        type: "get",
                        dataType: "JSON",
                        success: function(data) {
                            if (data.success == true) {
