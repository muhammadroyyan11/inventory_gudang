        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Opname Stock</div>
                </div>
                <div class="card-body mt-4">
                    <form id="form-cart">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-6 col-lg-4">
                                        <div class="mb-2">
                                            <label for="tgl">Tanggal Pelaksanaan <span style="color: red;">*</span></label>
                                    ...
                                    <div class="col-6 col-sm-6 col-lg-4">
                                        <div class="mb-2">
                                            <label for="bulan">Bulan Opname</label>
                                    ...
                                    <div class="col-6 col-sm-6 col-lg-4">
                                        <div class="mb-2">
                                            <label for="tahun">Tahun Opname</label>
                            ...
                            <div class="col-12 col-sm-12 col-lg-12 d-none">
                                    ...
                                    <table class="table table-centered table-sm table-bordered" style="min-width: 600px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <td align="center">Stock Sistem</td>
                                                <td align="center">Stock Real</td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#saveBtn', function(e) {
            ...
            var myurl = "<?= base_url('opname/store') ?>";
        ...
        $("body").on("change", "#gudang", function() {
            var lokasi_id = $("#gudang").val();
            if (lokasi_id == '') {
                return;
            }
            getAllProdukLokasi(lokasi_id);
        })
    ...
    function getProdukLokasi(lokasi, id) {
        var url = "<?= base_url('opname/getProdukLokasi') ?>?lokasi=" + lokasi + "&barang=" + id;
        $.ajax({
            type: "get",
            url: url,
            dataType: 'json',
    ...
    function getAllProdukLokasi(lokasi) {
        var url = "<?= base_url('opname/getProdukLokasi') ?>?lokasi=" + lokasi;
        $.ajax({
            type: "get",
            url: url,
            dataType: 'json',
    ...
    function addItemToCart(barang_id, lokasi_id, kode, barang, satuan = '', harga = 0, stock = 0, jumlah = 0, keterangan = '') {
        var id = barang_id;
        var item = {
            id: barang_id,
            lokasi_id: lokasi_id,
            ...
            total: Math.abs(parseInt(stock) - parseInt(jumlah))
        }
    ...
    function updateQuantity(id, jumlah) {
        ...
        for (let product of cart) {
            if (product.id == id) {
                ...
                product.total = Math.abs(parseInt(product.stock) - parseInt(jumlah));
            }
        }
        localStorage.setItem("cart", JSON.stringify(cart));
