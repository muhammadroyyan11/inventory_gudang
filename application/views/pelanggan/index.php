        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-3">
                    ...
                    <h4 id="modal-title" class="mt-2">Data Pelanggan</h4>
                </div>
                ...
                <form id="form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            <label for="kode">Kode Pelanggan <sup>(Optional)</sup></label>
...
<script>
    $(document).ready(function() {
        ...
        $("body").on('submit', '#form', function(e) {
            ...
            var id = $("#id").val();
            var url = "<?php echo base_url('pelanggan/store') ?>";
            if (id != '') {
        ...
        $("body").on("click", ".edit", function() {
            ...
            $('#form')[0].reset();
            $.ajax({
                url: "<?php echo base_url('pelanggan/get_by_id') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    $('#id').val(data.id);
        ...
        $("body").on("click", ".delete", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo base_url('pelanggan/delete') ?>/" + id,
                        type: "get",
                        dataType: "JSON",
                        success: function(data) {
                            if (data.success == true) {
