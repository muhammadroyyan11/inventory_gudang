            ...
            <form id="form" class="form-horizontal">
                <div class="modal-body" style="max-height: calc(100vh - 200px);overflow-y: auto;">
                    <div class="text-center mb-3">
                        ...
                        <h4 id="modal-title" class="mt-2">Data Supplier</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label for="kode">Kode Supplier <sup>(Optional)</sup></label>
                        ...
                        <div class="mb-2">
                            ...
                            <input name="email" id="email" class="form-control" required="" type="text">
                        </div>
                        <div class="mb-2">
...
<script>
    $(document).ready(function() {
        ...
        $("body").on('submit', '#form', function(e) {
            ...
            var id = $("#id").val();
            var url = "<?php echo base_url('supplier/store') ?>";
            if (id != '') {
        ...
        $("body").on("click", ".edit", function() {
            ...
            $('#form')[0].reset();
            $.ajax({
                url: "<?php echo base_url('supplier/get_by_id') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    $('#id').val(data.id);
