    ...
    <div class="card-body">
        ...
        <div class="clearfix">
            ...
            <div class="float-middle">
                <h4 class="m-0">Detail Transfer Barang</h4>
            </div>
        </div>
            ...
            ?>
                ...
                <table width="100%" cellpadding="10px" border="0">
                    <tr>
                        ...
                        <td valign="top">
                            <h5>Ke Gudang</h5>
                            <span class="font-13"><strong>Nama Gudang: </strong> <?= $transaksi->lokasi2_name ?? '' ?></span><br>
                            <span class="font-13"><strong>Alamat: </strong> <?= $transaksi->lokasi2_alamat ?? '' ?></span><br>
                            <span class="font-13"><strong>HP: </strong> <?= $transaksi->lokasi2_hp ?? '' ?></span>
                        </td>
